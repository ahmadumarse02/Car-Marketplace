      ...
      {isImageSearchActive && (
        <div className="mt-4">
          <form onSubmit={handleImageSearch}>
            <div className="flex flex-col items-center border-2 border-dashed border-gray-300 rounded-3xl p-6 text-center">
              {imagePreview ? (
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-gray-500 mb-2">
                      {isDragActive && !isDragReject
                        ...
                        : 'Drad & drop a car image or click to select'}
                    </p>
                    {isDragReject && <p className="text-red-500 mb-2">Invalid image type</p>}
                    <p className="text-gray-400 text-sm">Support: JPG, PNG (max 5MB)</p>
                  </div>
                </div>
              )}
            </div>
            {imagePreview && (
              <Button type="sublit" disabled={isUploading} className="mt-2 w-full">
